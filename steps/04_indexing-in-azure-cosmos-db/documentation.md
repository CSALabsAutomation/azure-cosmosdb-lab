...
4. In the popup, navigate to the [VolcanoData.json](../Labs/setup/) file. This file was copied in the pre-lab steps, if you do not have it run the account setup steps.
5. Select **Upload**
